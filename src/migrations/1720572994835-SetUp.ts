...
export class SetUp1720572994835 implements MigrationInterface {
  name = 'SetUp1720572994835';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "produto" ("id" SERIAL NOT NULL, "descricao" character varying(60) NOT NULL, "imagem" bytea, "custo" numeric(13,3) NOT NULL, CONSTRAINT "pk_produto" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
